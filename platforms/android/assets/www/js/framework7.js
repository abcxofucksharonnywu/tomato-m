    ...
    window.Framework7 = function (params) {
        ...
        ************   Views   ************
        ...
        app.sizeNavbars = function (viewContainer) {
            ...
            navbarInner.each(function () {
                ...
                if (center.hasClass('sliding') || center.hasClass('fixed')) center.css({left: centerLeft + 'px'});//shadow
            });
        };
        ...
        app.hideToolbar = function (toolbarContainer) {
            $(toolbarContainer).addClass('toolbar-hidden').transitionEnd(function () {
        ...
        ************   Based on solution by Marc Godard, https://github.com/MarcGodard   ************
        ...
        app.initImagesLazyLoad = function (pageContainer) {
            ...
            // Placeholder
            // var placeholderSrc = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEXCwsK592mkAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==';shadow
            var placeholderSrc = 'img/bg_image.png';
                    ...
                    '<div class="navbar-inner">' +
                        '<div class="left sliding">' +
                            '<a href="#" class="link close-popup photo-browser-close-link {{#unless backLinkText}}icon-only{{/unless}} {{js "this.type === \'page\' ? \'back\' : \'\'"}}">' +
                                '<i class="iconfont icon-iconcancel {{iconsColorClass}}"></i>' +//shadow
